var Module = function(Module) {
  ...
  if (typeof module !== 'undefined' && module.exports) {
    ...
    if (typeof __dirname === 'string') {
      Module['wasmBinaryFile'] = require('path').join(__dirname, 'hunspell.wasm');
    }
  ...
  function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || 'hunspell.wast';
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'hunspell.wasm';
    var asmjsCodeFile = Module['asmjsCodeFile'] || 'hunspell.temp.asm.js';
  ...
  var _Hunspell_create = (Module['_Hunspell_create'] = function() {
    return Module['asm']['_Hunspell_create'].apply(null, arguments);
  });
  ...
  var _Hunspell_destroy = (Module['_Hunspell_destroy'] = function() {
    return Module['asm']['_Hunspell_destroy'].apply(null, arguments);
  });
  ...
  var _Hunspell_suggest = (Module['_Hunspell_suggest'] = function() {
    return Module['asm']['_Hunspell_suggest'].apply(null, arguments);
  });
  ...
  var _Hunspell_spell = (Module['_Hunspell_spell'] = function() {
    return Module['asm']['_Hunspell_spell'].apply(null, arguments);
  });
